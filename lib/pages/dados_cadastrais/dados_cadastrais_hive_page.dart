...
import 'package:flutter_specialist/repositories/dados_cadastrais.repository.dart';
                ...
                children: [
                  ...
                  Column(
                    children: linguagens
                        .map((linguagem) => CheckboxListTile(
                            ...
                            value: dadosCadastraisModel.linguages
                                .contains(linguagem),
                            onChanged: (bool? value) {
                              if (value!) {
                                setState(() {
                                  dadosCadastraisModel.linguages.add(linguagem);
                                });
                              } else {
                                setState(() {
                                  dadosCadastraisModel.linguages
                                      .remove(linguagem);
                                });
                              }
                            }))
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      if (dadosCadastraisModel.linguages.isEmpty) {
